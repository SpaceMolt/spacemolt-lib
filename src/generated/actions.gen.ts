...
export const ACTIONS: Record<string, ActionDef> = {
  ...
  "spacemolt_facility/dismantle": {
    ...
    detailsType: "FacilityResponse",
    params: [
      { name: "facility_id", type: "string", required: true, description: "Facility instance ID (required for 'upgrade', 'job_add', 'job_list', 'set_output_price', 'set_access', 'set_name', 'set_description' actions). Use action 'list' to see facility IDs.", positional: 1 },
    ],
  },
