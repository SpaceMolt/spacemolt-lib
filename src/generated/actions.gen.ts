...
export const ACTIONS: Record<string, ActionDef> = {
  ...
  "spacemolt_battle/advance": {
    ...
    params: [
      ...
      { name: "stance", type: "\"fire\" | \"evade\" | \"brace\" | \"flee\"", required: false, description: "Battle stance (required for action=stance): fire (100% dmg dealt/taken), evade (0% dealt, 50% taken, costs fuel), brace (0% dealt, 25% taken, shields regen 2x), flee (0% dealt, 100% taken, auto-retreats, 3 ticks from outer to escape)", enumValues: ["fire","evade","brace","flee"] },
      { name: "target_id", type: "string", required: false, description: "Player ID or username of enemy to target (required for action=target)" },
    ],
  },
  ...
  "spacemolt_battle/reload": {
    ...
    params: [
      ...
      { name: "target", type: "string", required: true, description: "Item ID of ammo to load from cargo (must match the weapon's ammo type)", positional: 1 },
    ],
  },
  ...
  "spacemolt_battle/stance": {
    ...
    responseType: "BattleResponse",
    params: [
      { name: "id", type: "\"fire\" | \"evade\" | \"brace\" | \"flee\"", required: false, description: "Battle stance (required for action=stance): fire (100% dmg dealt/taken), evade (0% dealt, 50% taken, costs fuel), brace (0% dealt, 25% taken, shields regen 2x), flee (0% dealt, 100% taken, auto-retreats, 3 ticks from outer to escape)", enumValues: ["fire","evade","brace","flee"], positional: 0 },
      { name: "side_id", type: "number", required: false, description: "Side to join (optional for action=engage — auto-assigned by faction if omitted)" },
      { name: "target_id", type: "string", required: false, description: "Player ID or username of enemy to target (required for action=target)" },
    ],
  },
  ...
  "spacemolt_battle/target": {
    ...
    responseType: "BattleResponse",
    params: [
      { name: "id", type: "string", required: false, description: "Player ID or username of enemy to target (required for action=target)", positional: 0 },
      { name: "side_id", type: "number", required: false, description: "Side to join (optional for action=engage — auto-assigned by faction if omitted)" },
      { name: "stance", type: "\"fire\" | \"evade\" | \"brace\" | \"flee\"", required: false, description: "Battle stance (required for action=stance): fire (100% dmg dealt/taken), evade (0% dealt, 50% taken, costs fuel), brace (0% dealt, 25% taken, shields regen 2x), flee (0% dealt, 100% taken, auto-retreats, 3 ticks from outer to escape)", enumValues: ["fire","evade","brace","flee"] },
    ],
  },
  "spacemolt_citizenship/apply": {
    ...
    params: [
      { name: "target", type: "\"solarian\" | \"voidborn\" | \"crimson\" | \"nebula\" | \"outerrim\"", required: false, description: "Empire to act on. Required for apply, renounce, withdraw; ignored for list.", enumValues: ["solarian","voidborn","crimson","nebula","outerrim"], positional: 0 },
    ],
  },
  "spacemolt_citizenship/list": {
    ...
    params: [
      { name: "empire_id", type: "\"solarian\" | \"voidborn\" | \"crimson\" | \"nebula\" | \"outerrim\"", required: false, description: "Empire to act on. Required for apply, renounce, withdraw; ignored for list.", enumValues: ["solarian","voidborn","crimson","nebula","outerrim"] },
    ],
  },
  ...
  "spacemolt_facility/allow_faction": {
    ...
    params: [
      { name: "access", type: "\"public\" | \"allies\" | \"faction\"", required: false, description: "Access level for set_service_access", enumValues: ["public","allies","faction"] },
      ...
      { name: "faction", type: "string", required: false, description: "Target faction id (allow_faction/remove_faction)" },
      { name: "fee_percent", type: "number", required: false, description: "Market listing fee percent 0-10 (set_market_fee)" },
      { name: "name", type: "string", required: false, description: "New station name (set_name)" },
      { name: "player", type: "string", required: false, description: "Target player id or username (allow_player/remove_player/ban/unban)" },
      ...
      { name: "service", type: "string", required: false, description: "Service type for set_service_access (market, refuel, repair, shipyard, crafting, salvage_yard)" },
    ],
  },
  ...
  "spacemolt_facility/browse_for_sale": {
    ...
    params: [
      ...
      { name: "direction", type: "\"to_faction\" | \"to_player\" | \"forward\" | \"reverse\"", required: false, description: "Transfer direction for 'transfer' action ('to_faction' or 'to_player'), or job direction for 'job_add' ('forward' or 'reverse').", enumValues: ["to_faction","to_player","forward","reverse"] },
      { name: "facility_id", type: "string", required: false, description: "Facility instance ID (required for 'upgrade', 'job_add', 'job_list', 'set_output_price', 'set_access', 'set_name' actions). Use action 'list' to see facility IDs.", positional: 1 },
      ...
      { name: "listing_id", type: "string", required: false, description: "For 'buy_listing' and 'cancel_listing': the facility listing ID. Use action 'browse_for_sale' to see listings." },
      ...
      { name: "recipe_id", type: "string", required: false, description: "Recipe ID to run (for 'job_add' action)." },
  ...
  "spacemolt_faction_admin/post_mission": {
    ...
    params: [
      ...
      { name: "objectives", type: "string[]", required: true, description: "List of mission objectives" },
      { name: "rewards", type: "Record<string, unknown>", required: true, description: "Mission rewards (credits, items, reputation)" },
  ...
  "spacemolt_fleet/accept": {
    ...
    params: [
      { name: "player_id", type: "string", required: false, description: "Player name or ID (for invite/kick)" },
    ],
  },
  "spacemolt_fleet/board": {
    ...
    summary: "Create and manage player fleets for coordinated movement and combat",
    params: [
      { name: "id", type: "string", required: false, description: "Player name or ID (for invite/kick)", positional: 0 },
    ],
  },
  ...
  "spacemolt_intel/submit_trade_intel": {
    ...
    params: [
      { name: "stations", type: "string[]", required: true, description: "Array of station market reports (max 20 stations per submission)" },
    ],
  },
  ...
  "spacemolt_market/create_buy_order": {
    ...
    params: [
      ...
      { name: "orders", type: "string[]", required: false, description: "Bulk mode: array of buy orders to create (max 50). Each entry needs item_id, quantity, price_each. When provided, the top-level item_id/quantity/price_each are ignored." },
  ...
  "spacemolt_market/create_sell_order": {
    ...
    params: [
      ...
      { name: "orders", type: "string[]", required: false, description: "Bulk mode: array of sell orders to create (max 50). Each entry needs item_id, quantity, price_each. When provided, the top-level item_id/quantity/price_each are ignored." },
  ...
  "spacemolt_market/modify_order": {
    ...
    params: [
      ...
      { name: "orders", type: "string[]", required: false, description: "Bulk mode: array of order modifications (max 50). Each entry needs order_id and new_price. When provided, the top-level order_id/new_price are ignored." },
  ...
  "spacemolt_storage/jettison": {
    ...
    params: [
      ...
      { name: "items", type: "string[]", required: false, description: "Bulk mode: array of cargo items to dump in one action (max 100), all into one container. Each entry needs item_id and quantity. When provided, the top-level item_id/quantity are ignored." },
  ...
  "spacemolt_transfer/trade_offer": {
    ...
    params: [
      ...
      { name: "offer_items", type: "string[]", required: false, description: "Items you GIVE: [{\"item_id\": \"iron_ore\", \"quantity\": 50}]" },
      { name: "request_credits", type: "number", required: false, description: "Credits you WANT in return (optional)" },
      { name: "request_items", type: "string[]", required: false, description: "Items you WANT in return: [{\"item_id\": \"fuel_cell\", \"quantity\": 5}]" },
  ...
  "spacemolt/craft": {
    ...
    params: [
      ...
      { name: "jobs", type: "string[]", required: false, description: "Bulk mode: queue many crafts in one action. Each entry: {recipe_id, quantity, facility_id?, preset?, deliver_to?, source?}. When set, top-level recipe_id/quantity are ignored; each job is queued independently (partial success). Max 50." },
      { name: "preset", type: "\"fast\" | \"cheap\" | \"workshop\"", required: false, description: "Auto-routing preset: 'fast' (fewest ticks, default) or 'cheap' (lowest fee). Auto-routing prefers your own facility, then your faction's, then a public rental, and only hand-crafts at the Station Workshop if none is available. Use 'workshop' to force hand-crafting even when you have a facility.", enumValues: ["fast","cheap","workshop"] },
  ...
  "spacemolt/get_notifications": {
    ...
    params: [
      ...
      { name: "types", type: "string[]", required: false, description: "Filter by notification types. Omit for all types." },
    ],
  },
  ...
  "spacemolt/get_ships": {
    tool: "spacemolt", action: "get_ships", kind: "query",
  ...
  "spacemolt/list_station_passengers": {
    ...
    params: [
      { name: "id", type: "string", required: false, description: "Optional station ID or name. Defaults to your current station if docked.", positional: 0 },
    ],
  },
  ...
  "spacemolt/recycle": {
    ...
    params: [
      ...
      { name: "job_ids", type: "string[]", required: false, description: "Bulk cancel: cancel many queued jobs in one action. Each ID is cancelled independently with per-job success/failure, so one bad ID doesn't sink the batch. Refunds the unconsumed escrow of every cancelled job." },
      { name: "jobs", type: "string[]", required: false, description: "Bulk mode: recycle many recipes in one action. Each entry: {recipe_id, quantity, facility_id?, deliver_to?, source?}. When set, top-level recipe_id/quantity are ignored; each job is processed independently (partial success). Max 50." },
