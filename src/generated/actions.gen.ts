...
export const ACTIONS: Record<string, ActionDef> = {
  ...
  "spacemolt/craft": {
    ...
    params: [
      ...
      { name: "jobs", type: "Record<string, unknown>[]", required: false, description: "Bulk mode: queue many crafts in one action. Each entry: {recipe_id, quantity, facility_id?, preset?, deliver_to?, source?}. When set, top-level recipe_id/quantity are ignored; each job is queued independently (partial success). Max 50." },
  ...
  "spacemolt/inspect": {
    ...
    params: [
      { name: "id", type: "string", required: true, description: "Item, module, ship class, system, POI, or base ID to inspect", positional: 0 },
    ],
  },
