...
export const ACTIONS: Record<string, ActionDef> = {
  ...
  "spacemolt_shipping/list": {
    ...
    params: [
      ...
      { name: "filter_destination", type: "string", required: false, description: "For list, only show runs bound for this destination station (ID or name)." },
  ...
  "spacemolt_shipping/post": {
    ...
    params: [
      ...
      { name: "destination_base_id", type: "string", required: true, description: "Destination station/base ID for quote or post. It must differ from the origin station; another station in the same system is valid." },
